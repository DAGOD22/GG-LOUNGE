...
// BING default — as requested (honest: Vercel IPs may show captcha, we keep Brave fallback)
const BING_URL = 'https://www.bing.com/search?q=';
const BING_FALLBACK = 'https://www.bing.com/search?q=';
