...
const apps: App[] = [
  ...
  { id: 'bing', title: 'Bing', subtitle: 'Fixed • No captcha', description: 'Bing — fast, private search. Works at school, no blocks.', mark: 'B', color: 'stack', path: '/app-frames/bing/index.html', genre: 'Search' },
    ...
    <main className="lounge-shell" style={{background:'radial-gradient(800px 600px at 10% -10%, rgba(125,107,255,.12), transparent 60%), radial-gradient(700px 500px at 90% 0%, rgba(215,243,74,.10), transparent 60%), radial-gradient(600px 400px at 50% 100%, rgba(255,92,92,.06), transparent 60%), var(--background)'}}>
      ...
      <section className="hero" id="top" style={{paddingBottom:32, minHeight:520, position:'relative', overflow:'hidden'}}>
        ...
        <div className="hero-copy" style={{position:'relative', zIndex:1}}>
          ...
          <p className="hero-text" style={{maxWidth:520, fontSize:15, lineHeight:1.6}}>YouTube <strong style={{color:'#22c55e'}}>actually plays</strong> in the lounge • Bing <strong style={{color:'#4285F4'}}>fast search</strong> • TikTok <strong style={{color:'#ff2e63'}}>scrolls smooth</strong>. No installs, no blocks, just tap.</p>
          ...
          <div style={{display:'flex',gap:8, flexWrap:'wrap', marginTop:16}}>
            ...
            <span style={{display:'flex',alignItems:'center',gap:6, padding:'6px 12px', borderRadius:999, background:'rgba(66,133,244,.10)', border:'1px solid rgba(66,133,244,.2)', color:'#8ab4ff', fontSize:11, fontWeight:800}}><ShieldCheck size={12}/> Bing FIXED — fast search</span>
